...
var accoutInfoFile = __dirname + "/GorgeousAccountGroups.json";
...
web3.eth.getTransactionCount(addressFrom, "pending").then((txnCount) => {
  ...
  SaveBalaneOnLogFile(newAccountGroups.group2, balanceHistory);
});
